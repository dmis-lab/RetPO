...
def main():
    ...
    # Load datasets
    ###############
    target_key = "Truth_answer" if 'qrecc' in script_args.dataset_dir else "Answer"
    raw_datasets = get_qrecc_qa(script_args,
    ...
    # Apply chat template
    #####################
    raw_datasets = raw_datasets.map(apply_cqa_template, fn_kwargs={"tokenizer": tokenizer, "task": "sft"})
